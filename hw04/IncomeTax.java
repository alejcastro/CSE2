...
public class IncomeTax {
    ...
    public static void main(String[] args) {
            ...
            // greater than 0
            if (income > 0) { // this if statement will tell us if the user enter an int greater than 0 if not it will exit the program
                ...
                double nTaxes = taxes * 100; // this convert the decimal point whole  numbers 
                double tTaxes = income * 1000 * taxes; // this calculates the taxes to be payed by multiplying the income by the taxes 
                // remember that the user enter the income and then we have to multiplied it by a thousand
                // after we defined the tax we print our answer 
                // we need to eliminate all the unwanted decimal points, therefore we have to cast our answers 
                System.out.println("The tax rate on " + income * 1000 + " is " + ((int)(nTaxes) * 100) / 100 + "%, and the tax is " + ((int)(tTaxes) * 100) / 100.0 + " dollars");



            } // if the user did not enter an integer >0 than this else will exit the program and tell the user about his error
            else {
